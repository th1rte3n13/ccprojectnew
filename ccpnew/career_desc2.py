def display_job_info(job_title):
    job_info = {
        ...
        "API Integration Specialist": {
            "Job Description": "As an API Integration Specialist, you will be responsible for seamlessly integrating various software systems through the development and maintenance of APIs (Application Programming Interfaces). You will play a crucial role in ensuring efficient communication and data exchange between different platforms, enhancing overall system functionality and user experience.",
            "Prerequisites": "Bachelor's degree in Computer Science, Information Technology, or a related field. Proven experience in API development and integration projects. Proficiency in programming languages such as Python, Java, or JavaScript. Strong understanding of RESTful and/or SOAP APIs. Knowledge of authentication and authorization protocols (OAuth, JWT, API keys). Experience with version control systems (Git) and API testing tools. Excellent problem-solving and communication skills. Ability to work collaboratively in a team environment.",
            "Skill Enhancement": "Stay updated on new AI/ML algorithms, techniques, and tools. Engage in Kaggle competitions, research, and open-source projects. Pursue advanced degrees or certifications in ML, AI, or related fields.",
            "Job Prospects": [
                "https://in.linkedin.com/jobs/api-integration-jobs?position=1&pageNum=0",
                "https://www.glassdoor.co.in/Job/api-integration-specialist-jobs-SRCH_KO0,26.htm",
            ],
            "Courses links": [
                "https://www.coursera.org/learn/apis",
                "https://www.udemy.com/topic/api/",
            ],
        },
        "Application Support Engineer": {
            ...
            "Courses links": [
                "https://www.udemy.com/course/it-support-beginners-course/",
                "https://www.shiksha.com/online-courses/application-support-certification",
        ...
        "Business Analyst": {
            ...
            "Courses links": [
                ...
                "https://www.simplilearn.com/business-analyst-certification-training-course",
            ],
        },
        "Customer Service Executive": {
            ...
            "Courses links": [
                ...
                "https://www.shiksha.com/online-courses/customer-service-executive-certification",
                "https://www.coursera.org/courses?query=customer%20service",
            ],
        },
        "Cyber Security Specialist": {
            ...
            "Courses links": [
                ...
                "Coursera: https://www.coursera.org/courses?query=cybersecurity (University of Washington Specialization)",
                "edX: https://www.edx.org/learn/cybersecurity/university-of-washington-introduction-to-cybersecurity (Introduction to Cybersecurity)",
            ],
        },
        "Data Scientist": {
            ...
            "Courses links": [
                "Simplilearn Data Science Bootcamp: https://www.simplilearn.com/data-science-and-business-analytics",
                "Udemy The Complete Data Science Bootcamp 2024: https://www.udemy.com/course/complete-data-science-bootcamp/",
                "Great Learning PG Program in Data Science and Business Analytics: https://www.mygreatlearning.com/pg-program-data-science-and-business-analytics-course-classroom",
            ],
        },
        "Database Administrator": {
            ...
            "Courses links": [
                ...
                "https://www.coursera.org/courses?query=database%20administration"
                "https://www.edx.org/learn/databases/ibm-relational-database-administration-dba"
            ],
        },
        "Graphics Designer": {
            ...
            "Job Prospects": [
                ...
                "LinkedIn: https://in.linkedin.com/jobs/graphic-designer-jobs",
            ],
            "Courses links": [
        ...
        "Hardware Engineer": {
            ...
            "Job Prospects": [
                "https://in.linkedin.com/jobs/hardware-engineer-jobs?position=1&pageNum=0",
                "https://www.naukri.com/hardware-engineer-jobs",
            ],
            "Courses links": [
                "https://www.coursera.org/courses?query=hardware",
                "https://www.udemy.com/course/computer-hardware-engineering/",
            ],
        },
        "Project Manager": {
            ...
            "Job Prospects": [
                "https://in.linkedin.com/jobs/project-management-jobs?position=1&pageNum=0",
        ...
        "Helpdesk Engineer": {
            ...
            "Job Prospects": [
                "https://www.naukri.com/helpdesk-engineer-jobs",
                "https://in.linkedin.com/jobs/service-desk-engineer-jobs?position=1&pageNum=0",
            ],
            "Courses links": [
                "https://www.linkedin.com/learning/topics/it-help-desk-5",
        ...
        "Information Security Specialist": {
            ...
            "Job Prospects": [
                ...
                "https://in.indeed.com/q-information-security-jobs.html",
            ],
            "Courses links": [
                "https://www.coursera.org/courses?query=information%20security",
                "https://www.springboard.com/blog/cybersecurity/best-information-security-courses/",
            ],
        },
        "Networking Engineer": {
            ...
            "Job Prospects": [
                "https://www.naukri.com/network-engineer-jobs",
                "https://in.linkedin.com/jobs/network-engineer-jobs?position=1&pageNum=0",
            ],
            "Courses links": [
                "https://www.coursera.org/learning-paths/network-engineering",
                "https://www.udemy.com/topic/network-engineering/",
            ],
        },
        "Software Developer": {
            ...
            "Job Prospects": [
                ...
                "https://in.linkedin.com/jobs/software-engineer-jobs?position=1&pageNum=0",
            ],
        },
        "Software Tester": {
            ...
            "Courses links": [
                ...
                "https://www.coursera.org/courses?query=software%20testing",
            ],
            "Job Prospects": [
                "https://www.naukri.com/software-testing-jobs",
                "https://in.linkedin.com/jobs/software-tester-jobs?position=1&pageNum=0",
            ],
        },
        "Technical Writer": {
            ...
            "Job Prospects": [
                "https://www.naukri.com/technical-writer-jobs",
    ...
    if job_title in job_info:
        return job_info[job_title]
    else:
        return {
            "Information not available": "No information available for the selected job title."
        }
